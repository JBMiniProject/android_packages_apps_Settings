...
public class JBMiniSettings extends SettingsPreferenceFragment implements Preference.OnPreferenceChangeListener {
    ...
    private void writeDisableReboot() {
        ...
        if (DEBUG) Log.i(TAG, "Show Reboot option in Reboot Dialog: "   ? "enabled" : "disabled");
    }
    ...
    private void writeDisableScreenshot() {
        ...
        if (DEBUG) Log.i(TAG, "Show Screenshot option in Reboot Dialog: "   ? "enabled" : "disabled");
    }
    ...
    private void writeDisableAirplane() {
        ...
        if (DEBUG) Log.i(TAG, "Show Airplane mode option in Reboot Dialog: "   ? "enabled" : "disabled");
    }
    ...
    private void writeDisableRinger() {
        ...
        if (DEBUG) Log.i(TAG, "Show Ringer mode options in Reboot Dialog: "   ? "enabled" : "disabled");
    }
    ...
    private void writeDisableTitle() {
        ...
        if (DEBUG) Log.i(TAG, "Show Reboot Dialog title: "   ? "enabled" : "disabled");
    }
